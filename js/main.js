...
let imagesResponsive = document.querySelectorAll(
  '.c-top-slider__img--responsive'
);
...
function startJs() {
  ...
  const slideImages = () => {
    ...
    imagesResponsive[currentImageIndex].classList.remove(
    ...
    imagesResponsive[currentImageIndex].classList.add(
      'selected-img--responsive'
    );
  };
